...
namespace Callmeaf\Product\App\Http\Controllers\Api\V1;
...
class ProductController extends ApiController implements HasMiddleware
{
    ...
    {
        return $this->productRepo->latest()->builder(fn(Builder $query) => $query->ofStatus(ProductStatus::PUBLISHED->value)->published())->search()->paginate();
    }
