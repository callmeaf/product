...
use Callmeaf\Product\Utilities\V1\Api\ProductCategory\ProductCategoryResources;
    ...
    public function store(ProductCategoryStoreRequest $request)
    {
        try {
            ...
            return apiResponse([
                ...
                'title' => $productCategory->responseTitles(ResponseTitle::STORE),
            ]));
        } catch (\Exception $exception) {
            report($exception);
            return apiResponse([],$exception);
    ...
    public function update(ProductCategoryUpdateRequest $request,ProductCategory $productCategory)
    {
        try {
            ...
            return apiResponse([
                ...
                'title' =>  $productCategory->responseTitles(ResponseTitle::UPDATE)
            ]));
        } catch (\Exception $exception) {
            report($exception);
            return apiResponse([],$exception);
    ...
    public function statusUpdate(ProductCategoryStatusUpdateRequest $request,ProductCategory $productCategory)
    {
        try {
            ...
            return apiResponse([
                ...
                'title' =>  $productCategory->responseTitles(ResponseTitle::STATUS_UPDATE)
            ]));
        } catch (\Exception $exception) {
            report($exception);
            return apiResponse([],$exception);
    ...
    public function destroy(ProductCategoryDestroyRequest $request,ProductCategory $productCategory)
    {
        try {
            ...
            return apiResponse([
                ...
                'title' =>  $productCategory->responseTitles(ResponseTitle::DESTROY)
            ]));
        } catch (\Exception $exception) {
            report($exception);
            return apiResponse([],$exception);
    ...
    public function restore(ProductCategoryRestoreRequest $request,string|int $id)
    {
        try {
            ...
            return apiResponse([
                ...
                'title' =>  $productCategory->responseTitles(ResponseTitle::RESTORE)
            ]));
        } catch (\Exception $exception) {
            report($exception);
            return apiResponse([],$exception);
    ...
    public function forceDestroy(ProductCategoryForceDestroyRequest $request,string|int $id)
    {
        try {
            ...
            return apiResponse([
                ...
                'title' =>  $productCategory->responseTitles(ResponseTitle::FORCE_DESTROY)
            ]));
        } catch (\Exception $exception) {
            report($exception);
            return apiResponse([],$exception);
